function out = model
%
% hyperelastic_stretching_1.m
%
% Model exported on May 19 2025, 16:39 by COMSOL 6.3.0.335.
...
model.result.numerical('gev1').remove('unit', 0);
model.result.numerical('gev1').remove('descr', 0);
model.result.numerical('gev1').remove('expr', [0]);
model.result.numerical('gev1').set('table', 'tbl1');
model.result.numerical('gev1').setIndex('expr', 'lambda', 0);
model.result.numerical('gev1').set('table', 'tbl1');

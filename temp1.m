...
% temp1.m
%
% Model exported on May 20 2025, 20:24 by COMSOL 6.3.0.335.
...
model.component('comp1').common('pres_shell').set('analysisCaseEdited', true);
...
model.result.numerical('gev1').setIndex('expr', 'lambda', 0);
model.result.numerical('gev1').set('table', 'tbl1');
...
model.param.set('nominalStrain', '5[%]');
...
model.param.set('nominalStrain', '1[%]');
...
model.result.numerical('gmev1').set('data', 'dset4');
model.result.numerical.remove('gmev1');
model.result.numerical.create('gev2', 'EvalGlobal');
model.result.numerical('gev2').set('data', 'dset4');
model.result.numerical('gev2').setIndex('expr', '0.5*(maxop1(shell.w) - minop1(shell.w))/th', 0);
...
model.result('pg7').run;
model.result('pg7').run;
model.result.numerical('gev2').setIndex('expr', '0.5*(maxop1(w) - minop1(w))/th', 0);
model.result.numerical('gev2').set('table', 'tbl2');

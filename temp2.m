...
% temp2.m
%
% Model exported on May 21 2025, 02:45 by COMSOL 6.3.0.335.
...
model.result.numerical('gev2').set('expr', {'0.5*(maxop1(comp1.w) - minop1(comp1.w))/th'});
model.result.numerical('gev2').set('unit', {'1'});
model.result.numerical('gev2').set('descr', {'Wrinlke Amplitude'});
model.result.numerical('gev2').set('const', {'shell.refpntx' '0' 'Reference point for moment computation, x-coordinate'; 'shell.refpnty' '0' 'Reference point for moment computation, y-coordinate'; 'shell.refpntz' '0' 'Reference point for moment computation, z-coordinate'});
model.result.numerical('gev3').set('looplevelinput', {'manual'});
model.result.numerical('gev3').set('looplevel', [61]);
model.result.numerical('gev3').set('table', 'tbl3');
model.result.numerical('gev3').set('expr', {'0.5*(maxop1(comp1.w) - minop1(comp1.w))/th'});
model.result.numerical('gev3').set('unit', {'1'});
model.result.numerical('gev3').set('descr', {''});
model.result.numerical('gev3').set('const', {'shell.refpntx' '0' 'Reference point for moment computation, x-coordinate'; 'shell.refpnty' '0' 'Reference point for moment computation, y-coordinate'; 'shell.refpntz' '0' 'Reference point for moment computation, z-coordinate'});
...
model.result('pg4').feature('surf1').feature('def').set('scale', 1.1733728218671009E7);
...
model.result('pg5').feature('surf2').feature('def1').set('scale', 0.46682426628854096);
...
model.result('pg5').feature('surf3').feature('def1').set('scale', 0.23341213314427048);
...
model.result('pg5').feature('surf4').feature('def1').set('scale', 0.155608088762847);
